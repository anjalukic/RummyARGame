...
#pragma warning restore 618
    {
        ...
        public override void OnStartLocalPlayer()
        {
            ...
            //LocalPlayerController player = GameObject.Find("LocalPlayer").GetComponent<LocalPlayerController>();
            GameObject networkGameController = GameObject.Find("NetworkGameController");
            if (!networkGameController.GetComponent<NetworkIdentity>().hasAuthority)
            {
                this.CmdSetAuth(networkGameController.GetComponent<NetworkIdentity>(), this.GetComponent<NetworkIdentity>());
            }
        }
...
#pragma warning restore 618
        ...
        [Command]
        public void CmdSetAuth(NetworkIdentity obj, NetworkIdentity player)
        {
            obj.AssignClientAuthority(player.connectionToClient);
        }
