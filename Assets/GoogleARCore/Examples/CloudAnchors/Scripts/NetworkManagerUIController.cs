...
#pragma warning restore 618
        ...
        public GameObject networkGameController;
...
#pragma warning restore 618
        ...
        public void OnCreateRoomClicked()
        {
            m_Manager.matchMaker.CreateMatch(m_Manager.matchName, m_Manager.matchSize,
                                           ...
                                           0, 0, _OnMatchCreate);
           networkGameController.GetComponent<NetworkGameController>().isHost = true;////////////////////////////////////////////////
           networkGameController.GetComponent<NetworkGameController>().myTurn = true;
        }
        ...
        public void OnReturnToLobbyClick()
        {
            ...
            SnackbarText.text = "Dropping match...";
        ...
        public void OnAnchorHosted(bool success, string response)
        {
            if (success)
            {
                SnackbarText.text = "Cloud Anchor successfully hosted! The game is about to start...";
            }
            else
            {
        ...
        public void OnAnchorResolved(bool success, string response)
        {
            if (success)
            {
                SnackbarText.text = "Cloud Anchor successfully resolved! The game is about to start...";
            }
            else
            {
                SnackbarText.text =
...
#pragma warning restore 618
        {
            ...
            networkGameController.GetComponent<NetworkGameController>().isHost = false;/////////////////////////////////////////////
            networkGameController.GetComponent<NetworkGameController>().myTurn = false;//////////////////////////////////////////////////
...
#pragma warning restore 618
            Debug.Log("changing scene"+SceneManager.GetActiveScene().name);
            SceneManager.LoadScene("GameScene");/////////////////////////////////////////////////////////////SceneManager.LoadScene("CloudAnchors");
        }
