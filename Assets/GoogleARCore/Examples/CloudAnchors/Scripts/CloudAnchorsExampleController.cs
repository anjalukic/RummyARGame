...
#pragma warning restore 618
        ...
        private void initGameplay(bool isHost)
        {
            //////////////////////////////////
            GameObject.Find("GameController").GetComponent<SelectAndDrag>().enabled = true;
            ARCoreWorldOriginHelper.gameObject.SetActive(false);
            GameObject.Find("Point Cloud").SetActive(false);

            GameObject networkGameController = GameObject.Find("NetworkGameController");
            networkGameController.GetComponent<NetworkGameController>().CmdPlayerJoins();
            
            ///check if all joined
            //if (isHost && networkGameController.GetComponent<NetworkGameController>().gameStarted)
